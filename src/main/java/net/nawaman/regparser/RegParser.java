...
import net.nawaman.regparser.parsers.*;
...
public class RegParser implements Checker, Serializable {
	...
	static public class ConstructionEntry {
		...
		public ConstructionEntry(              Checker  pChecker)                                                { this( null, (Object)pChecker,         null,         null); }
		public ConstructionEntry(              Checker  pChecker,                          Checker pSecondStage) { this( null, (Object)pChecker,         null, pSecondStage); }
		public ConstructionEntry(              Checker  pChecker, Quantifier pQuantifier)                        { this( null, (Object)pChecker,  pQuantifier,         null); }
		public ConstructionEntry(              Checker  pChecker, Quantifier pQuantifier,  Checker pSecondStage) { this( null, (Object)pChecker,  pQuantifier, pSecondStage); }
		public ConstructionEntry(String pName, Checker  pChecker)                                                { this(pName, (Object)pChecker,         null,         null); }
		public ConstructionEntry(String pName, Checker  pChecker,                          Checker pSecondStage) { this(pName, (Object)pChecker,         null, pSecondStage); }
		public ConstructionEntry(String pName, Checker  pChecker, Quantifier pQuantifier)                        { this(pName, (Object)pChecker,  pQuantifier,         null); }
		public ConstructionEntry(String pName, Checker  pChecker, Quantifier pQuantifier,  Checker pSecondStage) { this(pName, (Object)pChecker,  pQuantifier, pSecondStage); }
		public ConstructionEntry(              PType    pPType)                                                  { this( null, (Object)pPType,           null,         null); }
		public ConstructionEntry(              PType    pPType,                            Checker pSecondStage) { this( null, (Object)pPType,           null, pSecondStage); }
		public ConstructionEntry(              PType    pPType,   Quantifier pQuantifier)                        { this( null, (Object)pPType,    pQuantifier,         null); }
		public ConstructionEntry(              PType    pPType,   Quantifier pQuantifier,  Checker pSecondStage) { this( null, (Object)pPType,    pQuantifier, pSecondStage); }
		public ConstructionEntry(String pName, PType    pPType)                                                  { this(pName, (Object)pPType,           null,         null); }
		public ConstructionEntry(String pName, PType    pPType,                            Checker pSecondStage) { this(pName, (Object)pPType,           null, pSecondStage); }
		public ConstructionEntry(String pName, PType    pPType,   Quantifier pQuantifier)                        { this(pName, (Object)pPType,    pQuantifier,         null); }
		public ConstructionEntry(String pName, PType    pPType,   Quantifier pQuantifier,  Checker pSecondStage) { this(pName, (Object)pPType,    pQuantifier, pSecondStage); }
		public ConstructionEntry(              PTypeRef pPTypeRef)                                               { this( null, (Object)pPTypeRef,        null,         null); }
		public ConstructionEntry(              PTypeRef pPTypeRef,                         Checker pSecondStage) { this( null, (Object)pPTypeRef,        null, pSecondStage); }
		public ConstructionEntry(              PTypeRef pPTypeRef, Quantifier pQuantifier)                       { this( null, (Object)pPTypeRef, pQuantifier,         null); }
		public ConstructionEntry(              PTypeRef pPTypeRef, Quantifier pQuantifier, Checker pSecondStage) { this( null, (Object)pPTypeRef, pQuantifier, pSecondStage); }
		public ConstructionEntry(String pName, PTypeRef pPTypeRef)                                               { this(pName, (Object)pPTypeRef,        null,         null); }
		public ConstructionEntry(String pName, PTypeRef pPTypeRef,                         Checker pSecondStage) { this(pName, (Object)pPTypeRef,        null, pSecondStage); }
		public ConstructionEntry(String pName, PTypeRef pPTypeRef, Quantifier pQuantifier)                       { this(pName, (Object)pPTypeRef, pQuantifier,         null); }
		public ConstructionEntry(String pName, PTypeRef pPTypeRef, Quantifier pQuantifier, Checker pSecondStage) { this(pName, (Object)pPTypeRef, pQuantifier, pSecondStage); }
		...
		public Checker    getChecker()    { return (this.Item instanceof  Checker)?(Checker) this.Item:null; }
		public PType      getType()       { return (this.Item instanceof    PType)?(PType)   this.Item:null; }
		public PTypeRef   getTypeRef()    { return (this.Item instanceof PTypeRef)?(PTypeRef)this.Item:null; }
		public boolean    isChecker()     { return (this.Item instanceof  Checker);                          }
		public boolean    isType()        { return (this.Item instanceof    PType);                          }
		public boolean    isTypeRef()     { return (this.Item instanceof PTypeRef);                          }
		public Quantifier getQuantifier() { return this.Quantifier;                                          }
		
		public boolean hasSecondStage() { return (this.SecondStage != null); }
		public Checker getSecondStage() { return this.SecondStage;           }
	...
	static public RegParser newRegParser(PTypeProvider pTProvider, ConstructionEntry ... pEntries) {
		if(pEntries == null) throw new NullPointerException();
		...
		for(int i = 0; i < pEntries.length; i++) {
			...
			if(     CE.isChecker()) RPEs.add(RPEntry._new(CE.getName(), CE.getChecker(), CE.getQuantifier()));
			else if(CE.isType())    RPEs.add(RPEntry._new(CE.getName(), CE.getType(),    CE.getQuantifier()));
			else if(CE.isTypeRef()) RPEs.add(RPEntry._new(CE.getName(), CE.getTypeRef(), CE.getQuantifier()));
		}
	...
	static public RegParser newRegParser(PTypeProvider pTProvider, Object ... pParams) {
		if(pParams == null) throw new NullPointerException();
		Vector<RPEntry> RPEs = new Vector<RPEntry>();
		...
		for(int i = 0; i < pParams.length; i++) {
			...
			if(O instanceof RPEntry) {
				if(IsNew) {
					if     (C  != null) RPEs.add(RPEntry._new(N, C,  Q));
					else if(T  != null) RPEs.add(RPEntry._new(N, T,  Q));
					else if(TR != null) RPEs.add(RPEntry._new(N, TR, Q));
					else throw new IllegalArgumentException("Invalid parameters ("+Arrays.toString(pParams)+").");
					IsNew = false; N = null; C = null; T = null; TR = null; Q = null;
				}
				...
				if(!((String)O).startsWith("$") && !((String)O).startsWith("#"))
					throw new IllegalArgumentException("Name of RegParser entry must start with '$' or '#' ("+((String)O)+").");
				...
				if((O == null) && !IsNew && !IsSkipped) IsSkipped = true;	// Skip for Name
				else throw new IllegalArgumentException("Invalid parameters ("+Arrays.toString(pParams)+").");
			}
		}
		if(IsNew || (N != null)) {
	...
	static public RegParser newRegParser(PTypeProvider pTProvider, String pText) {
		...
		if(RPTProvider == null) {
			...
			try {
				PTypeProvider PT = (PTypeProvider.Extensible)(Util.loadObjectsFromStream(
						ClassLoader.getSystemResourceAsStream(RegParserCompiler))[0]);
		...
		if(IsToSave) {
			...
			// Save for later use
			try { Util.saveObjectsToFile(RegParserCompiler, new Serializable[] { RPTProvider }); }
			catch (Exception E) {}
		}
	...
	public RPEntry getEntryAt(int pIndex) {
		if((pIndex < 0) || (pIndex >= this.getEntryCount())) return null;
		return this.Entries[pIndex];
	}
	
	// Default TypePackage ---------------------------------------------------------------------------------------------
	
	PTypeProvider getDefaultTypeProvider() { return null; }
	...
	static public class WithDefaultTypeProvider extends RegParser {
		...
		static public RegParser attachDefaultTypeProvider(RegParser pRegParser, PTypeProvider pTProvider) {
			if((pRegParser == null) || (pTProvider == null)) return pRegParser;
		...
		@Override PTypeProvider getDefaultTypeProvider() { return this.TProvider; }
	...
	public ParseResult parse(CharSequence pText, PTypeProvider pProvider) {
		...
		if(PR != null) PR.collapse(pProvider);
		return PR;
	}
	/** Returns the match if the text is start with a match (from pOffset on) or -1 if not */
	...
	public ParseResult match(CharSequence pText) {
		...
		if((PR != null) && (pText != null)) {
			if(PR.getEndPosition() != pText.length()) return null;
			PR.collapse(null);
		}
		return PR;
	}
	...
	public ParseResult match(CharSequence pText, int pOffset, int pEndPosition) {
		ParseResult PR = this.parse(pText, pOffset, 0, 0, null, null, null, null, 0);
		if((PR != null) && (pText != null)) {
			if(PR.getEndPosition() != pEndPosition) return null;
			PR.collapse(null);
		}
		return PR;
	}
	...
	protected ParseResult parseEach_P(CharSequence pText, int pOffset, int pIndex, String FN, PType FT, PTypeRef FTR,
		...
		if(IsFPAlternative) {
			...
			if(IsFPAsNode) {
				...
				if(IsFPType || IsFPName) pResult.append(ParseResult.newEntry(MaxResult.getEndPosition(), this.Entries[pIndex]));
				else                     pResult.mergeWith((ParseResult.Temp)MaxResult);
			}
			return pResult;
			
		} else if(IsFPNormalChecker) {
			if(pOffset >= pText.length()) return null; //pResult;
			...
			if(IsFPName) pResult.append(ParseResult.newEntry(pOffset + LengthFP, this.Entries[pIndex]));
			else         pResult.append(ParseResult.newEntry(pOffset + LengthFP));
			...
			if(IsFPName) {
				...
				if((((RegParser)FP).parse(pText, pOffset, 0, 0, TryResult, pProvider, null, null, pTabs + 1)) == null) return null;

				// Merge the result
				if(IsFPAsNode) {
					pResult.append(ParseResult.newEntry(TryResult.getEndPosition(), this.Entries[pIndex], TryResult));
				} else {
					if(IsFPType || IsFPName) pResult.append(ParseResult.newEntry(TryResult.getEndPosition(), this.Entries[pIndex]));
					else                     pResult.append(ParseResult.newEntry(TryResult.getEndPosition()));
				}
				return pResult;
			...
			if(FTR != null) {
				...
				if(FT == null) {
					...
					if(FT == null)  {
						throw new RPParsingException("RegParser type named '" + FTR.getName() + "' is not found.");
					}
				}
			}
			...
			if(FP instanceof RegParser) {
				...
				TryResult = ((RegParser)FP).parse(pText, pOffset, 0, 0, TryResult, pProvider,
						...
						((FT != null) && FT.isSelfContain())?null:Param,
						pTabs + 1);
				...
				if(pText.length() >= (pOffset + CG.getNeededLength())) {
					...
					for(int i = 0; i < CG.getEntryCount(); i++) {
						...
						if(l != -1) EndPosition += l; else EndPosition = pText.length(); 
						ThisResult.append(ParseResult.newEntry(EndPosition, CG.getEntry(i).getRPEntry()));
					}
				}	
			} else{
			...
			if((FT != null) && FT.hasValidation() &&  FT.isSelfContain()) {
				...
				if(!FT.validate(pResult, PR, Param, pProvider)) return null;
			}
			...
			if(IsFPAsNode) {
				...
				if(IsFPType || IsFPName) pResult.append(ParseResult.newEntry(EndPosition, this.Entries[pIndex]));
				else                     pResult.append(ParseResult.newEntry(EndPosition));
			}
			...
			if(pText.length() < (pOffset + CG.getNeededLength())) return null;
	...
	protected ParseResult parse(CharSequence pText, int pOffset, int pIndex, int pTimes, ParseResult pResult,
		...
		if(pResult == null) pResult = new ParseResult.Root(pOffset, pText);
		if(pText == null) return pResult;
		...
		if(DebugMode) {
			while(pTabs >= Tabs.size()) {
				if(Tabs.size() == 0) Tabs.add("");
				if(StrTabs == "") StrTabs = Tabs.get(Tabs.size() - 1);
				StrTabs += "  ";
				Tabs.add(StrTabs);
			}
			
			if(pTabs <= Tabs.size()) StrTabs = Tabs.get(pTabs);
			else {
				for(int i = pTabs; --i >= 0; ) StrTabs += "  ";
				Tabs.add(StrTabs);
			}
		}
		...
		MainLoop: while(true) {
			...
			if(pOffset >= TextLength) {
				...
				if(!ToTry) break MainLoop;
			}

			// TOHIDE
			/* */
			if(RegParser.DebugMode) {
				if(DebugPrintStream == null) DebugPrintStream = System.out;
				DebugPrintStream.println(StrTabs + pResult.toString(pTabs, 0));
				DebugPrintStream.println(StrTabs + "----------------------------------------------------------------------------------");
				String T = null;
				if(TextLength >= 50) T = pText.subSequence(pOffset, ((pOffset + 50) >= TextLength)?TextLength:(pOffset + 50)).toString() + "...";
				else                 T = pText.subSequence(pOffset, TextLength).toString();
				DebugPrintStream.println(StrTabs + "`" + Util.escapeText(T) + "` ~ " +
						((pRPType != null)?pRPType + "("+pRPTParam+") ~ ":"") +
						this.Entries[pIndex] + ((pTimes != 0)?"("+pTimes+")":""));
			}
			/* */
			...
			if(FPQ.isPossessive()) {
				...
				if((FPQ.UBound == -1) || (pTimes < FPQ.UBound)) {	// Not yet
					...
					if(IsFPAlternative) {
						...
						for(int c = CA.Checkers.length; --c >= 0; ) {
							...
							if(this.parseEach_P(pText, pOffset, pIndex, null, null, null, C, TryResult, pProvider, pTabs) != null) {
								// Match
								...
								if(MaxLength >= TryResult.getEndPosition()) continue;
								MaxResult = TryResult;
								MaxLength = TryResult.getEndPosition();

								if((MaxLength + pOffset) >= TextLength) break;
							}
						}
				...
				// Check if it fail to reach the minimum, return as not found
				if(pTimes < FPQ.LBound) return null;
				...
				if(pTimes >= FPQ.LBound) {
					...
					if(this.parse(pText, pOffset, pIndex + 1, 0, pResult, pProvider, pRPType, pRPTParam, pTabs) != null) {
						// Found the match.
						break MainLoop;
					}
				...
				if((FPQ.UBound != -1) && (pTimes >= FPQ.UBound)) return null; // Yes
				...
				if(IsFPAlternative) {
					...
					for(int c = CA.Checkers.length; --c >= 0; ) {
						// Try the first part
						ParseResult.Temp TryResult = new ParseResult.Temp(pResult);
						if(this.parseEach_P(pText, pOffset, pIndex, null, null, null, CA.Checkers[c], TryResult, pProvider, pTabs) != null) {
							// Match
							// Try the later part, if not match, continue other alternatives
							if(this.parse(pText, TryResult.getEndPosition(), pIndex, pTimes + 1, TryResult, pProvider,
									pRPType, pRPTParam, pTabs) == null) 
								continue;
	
							// Match, so record as max
							// Find the longer length
							if(MinLength <= TryResult.getEndPosition()) continue;
							MinResult = TryResult;
							MinLength = TryResult.getEndPosition();
							
							if((MinLength + pOffset) >= pOffset) break;
						}
					}
		...
		if((pRPType != null) && pRPType.hasValidation() && !pRPType.isSelfContain()) {
			...
			if(!pRPType.validate(Host, PR, pRPTParam, pProvider)) return null;
		}
	...
	public Checker getOptimized() {
		if((this.Entries.length == 1) && (this.Entries[0].getName() == null)
				&& (this.Entries[0].getTypeRef() == null)
		...
		for(int i = 0; i < this.Entries.length; i++) {
			...
			} else  RPEs[i] = RPEntry._new(RPE.getName(), RPE.getChecker(), RPE.getQuantifier());
		}
		
		if(IsChanged) return RegParser.newRegParser((Object[])RPEs);
		return this;
	}
	...
	@Override public boolean equals(Object O) {
		...
		if(!(O instanceof RegParser)) return false;
