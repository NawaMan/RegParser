...
public interface CompilationContext {
	...
	/** Returns the position as a string */   public String getLocationAsString(int pPos);
		
	/** Reports a warning with a cause*/      public void reportWarning(   String pMessage, Throwable pCause);
	/** Reports an error with a cause */      public void reportError(     String pMessage, Throwable pCause);
	/** Reports a fatal error with a cause */ public void reportFatalError(String pMessage, Throwable pCause);
		
	/** Reports a warning with a cause*/      public void reportWarning(   String pMessage, Throwable pCause, int pPos);
	/** Reports an error with a cause */      public void reportError(     String pMessage, Throwable pCause, int pPos);
	/** Reports a fatal error with a cause */ public void reportFatalError(String pMessage, Throwable pCause, int pPos);
	
	/** A simple implementation of Context */
	static public class Simple implements CompilationContext {
		
		public Simple() { this(true); }
		...
		public void reportWarning(String pMessage, Throwable pCause) {
			if(this.UseErrorPrintStreamForWarning) System.err.println("WARNING: " + pMessage);
			else                                   System.out.println("WARNING: " + pMessage);
			if(pCause != null) pCause.printStackTrace(this.UseErrorPrintStreamForWarning?System.err:System.out);
		}

		/** Reports an error with a cause */
		public void reportError(String pMessage, Throwable pCause) {
			System.err.println("ERROR: " + pMessage);
			if(pCause != null) pCause.printStackTrace(System.err);
		}
		...
		public void reportWarning(String pMessage, Throwable pCause, int pPos) {
			String Msg = String.format(
					"WARNING: %s%s", pMessage,
					(pPos < 0)
			            ? ""
			            : String.format(" near %s", this.getLocationAsString(pPos)));
		...
		/** Returns the string representation of this compilation context */ @Override
