...
public class Test_04_RegParser {
	...
	static public void main(String ... Arvs) {
		...
		if(!IsQuiet) System.out.println(RP.parse("TwoOne"));
		...
		if(!IsQuiet) System.out.println(RP.parse("OneTwo"));
		...
		if(!IsQuiet) System.out.println(RP.toString());
		if(!IsQuiet) System.out.println(RP.parse("Color"));
		if(!IsQuiet) System.out.println(RP.parse("Colour"));
		...
		if(!IsQuiet) System.out.println(RP.toString());
		if(!IsQuiet) System.out.println(RP.parse("Colour"));
		if(!IsQuiet) System.out.println(RP.parse("Colouur"));
		...
		if(!IsQuiet) System.out.println(RP.parse("Colur"));
		if(!IsQuiet) System.out.println(RP.parse("Colour"));
		if(!IsQuiet) System.out.println(RP.parse("Coloour"));
		if(!IsQuiet) System.out.println(RP.parse("Colouour"));
		if(!IsQuiet) System.out.println(RP.parse("Colooouour"));
		if(!IsQuiet) System.out.println(RP.parse("Colouoouoour"));
