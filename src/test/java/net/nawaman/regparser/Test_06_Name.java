...
public class Test_06_Name {
    ...
    static public void main(String... Args) {
        ...
        RP = RegParser.newRegParser(
                RPEntry._new("#Name",
                        RegParser.newRegParser(PredefinedCharClasses.Alphabet, PredefinedCharClasses.AlphabetAndDigit,
                                Quantifier.ZeroOrMore)),
                PredefinedCharClasses.Blank, Quantifier.ZeroOrMore, new CharSingle('['), PredefinedCharClasses.Blank,
                Quantifier.ZeroOrMore, RPEntry._new("#Index", PredefinedCharClasses.Digit, Quantifier.OneOrMore),
                PredefinedCharClasses.Blank, Quantifier.ZeroOrMore, new CharSingle(']'), PredefinedCharClasses.Blank,
                Quantifier.ZeroOrMore,
                RPEntry._new(
                        RegParser.newRegParser(new CharSingle('='), PredefinedCharClasses.Blank, Quantifier.ZeroOrMore,
                                RPEntry._new("#Value",
        ...
        if (!IsQuiet)
            System.out.println(PR.getAllNames().toString());
        if (!IsQuiet)
            System.out.println(PR.textOf("#Name"));
        if (!IsQuiet)
            System.out.println(PR.textOf("#Index"));
        if (!IsQuiet)
        ...
        RP = RegParser.newRegParser(new CharSingle('{'), PredefinedCharClasses.Blank, Quantifier.ZeroOrMore,
                ...
                RPEntry._new(
                        RegParser.newRegParser(new CharSingle(','), PredefinedCharClasses.Blank, Quantifier.ZeroOrMore,
                                RPEntry._new("#Value",
                                        RegParser.newRegParser(PredefinedCharClasses.Digit, Quantifier.OneOrMore))),
                        Quantifier.ZeroOrMore),
                PredefinedCharClasses.Blank, Quantifier.ZeroOrMore, new CharSingle(','), Quantifier.ZeroOrOne,
                PredefinedCharClasses.Blank, Quantifier.ZeroOrMore, new CharSingle('}'), PredefinedCharClasses.Blank,
        ...
        if (!IsQuiet)
            System.out.println(PR.getAllNames().toString());
        if (!IsQuiet)
            System.out.println(Arrays.toString(PR.textsOf("#Value")));
        if (!IsQuiet)
            System.out.println(Arrays.toString(PR.getAllOfStrMatchesByName("#Value")));
