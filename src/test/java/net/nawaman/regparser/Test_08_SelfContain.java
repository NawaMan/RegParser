    ...
    static public void main(String... Args) {
        ...
        PType RT_Int_0To24 = new RPTypeTest(IsQuiet) {
            ...
            public boolean doValidate(ParseResult pHostResult, ParseResult pThisResult, String pParam,
                ...
                if (!this.IsQuiet)
                    System.out.println(this.getName() + ": " + S + " = " + ((I >= 0) && (I <= 24)) + ";");
                return (I >= 0) && (I <= 24);
            }
        };
        ...
        PType RT_Int_25To50 = new RPTypeTest(IsQuiet) {
            ...
            public boolean doValidate(ParseResult pHostResult, ParseResult pThisResult, String pParam,
                ...
                int    I = Integer.parseInt(S);
                if (!this.IsQuiet)
                    System.out.println(this.getName() + ": " + S + " = " + ((I >= 25) && (I <= 50)) + ";");
                return (I >= 25) && (I <= 50);
            }
        };
        RP = RegParser.newRegParser(new CheckerAlternative(RegParser.newRegParser("#Value_Low", RT_Int_0To24),
                RegParser.newRegParser("#Value_High", RT_Int_25To50)), Quantifier.ZeroOrMore_Maximum);
        if (!IsQuiet)
        ...
        if (!IsQuiet)
            System.out.println(Util.toString(PR.textsOf("#Value_Low")));
        if (!IsQuiet)
            System.out.println(Util.toString(PR.textsOf("#Value_High")));
