...
public class Test_10_RegParserCompiler_2 {
	...
	static public void AssertNotNull(Object pValue) { if(pValue == null) throw new AssertionError(); }
	static public void AssertNull(   Object pValue) { if(pValue != null) throw new AssertionError(); }
	...
	static public void main(String ... Args) {
		...
		if(!IsQuiet) System.out.println((PR == null)?"null":PR.toString());
		O = MyRPTP.getType(TName).compile(PR, null, null, MyRPTP).toString();
		if(!IsQuiet) System.out.println(O);
		Assert(O, "" + c);
		...
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\p{Lower}",  MyRPTP)), PredefinedCharClasses.LowerCaseAlphabet);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\p{Upper}",  MyRPTP)), PredefinedCharClasses.UpperCaseAlphabet);
		...
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\p{Alnum}",  MyRPTP)), PredefinedCharClasses.AlphabetAndDigit);
		...
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\p{XDigit}", MyRPTP)), PredefinedCharClasses.HexadecimalDigit);
		...
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\jp{Lower}",   MyRPTP)), PredefinedCharClasses.Java_LowerCaseAlphabet);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\jp{Upper}",   MyRPTP)), PredefinedCharClasses.Java_UpperCaseAlphabet);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\jp{ASCII}",   MyRPTP)), PredefinedCharClasses.Java_ASCII);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\jp{Alpha}",   MyRPTP)), PredefinedCharClasses.Java_Alphabet);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\jp{Alnum}",   MyRPTP)), PredefinedCharClasses.Java_AlphabetAndDigit);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\jp{Punct}",   MyRPTP)), PredefinedCharClasses.Java_Punctuation);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\jp{Graph}",   MyRPTP)), PredefinedCharClasses.Java_Visible);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\jp{Print}",   MyRPTP)), PredefinedCharClasses.Java_Printable);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\jp{Blank}",   MyRPTP)), PredefinedCharClasses.Java_Blank);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\jp{Cntrl}",   MyRPTP)), PredefinedCharClasses.Java_ControlCharacter);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\jp{XDigit}",  MyRPTP)), PredefinedCharClasses.Java_HexadecimalDigit);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\jp{InGreek}", MyRPTP)), PredefinedCharClasses.Java_Greek);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("\\jp{Sc}",      MyRPTP)), PredefinedCharClasses.Java_CurrencySimbol);
		...
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:WhiteSpace:]",    MyRPTP)), PredefinedCharClasses.WhiteSpace);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:NonWhiteSpace:]", MyRPTP)), PredefinedCharClasses.NonWhiteSpace);
		...
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:NonOctDigit:]",   MyRPTP)), PredefinedCharClasses.NonOctalDigit);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:HexDigit:]",      MyRPTP)), PredefinedCharClasses.HexadecimalDigit);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:NonHexDigit:]",   MyRPTP)), PredefinedCharClasses.NonHexadecimalDigit);
		
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:LowerCaseAlphabet:]", MyRPTP)), PredefinedCharClasses.LowerCaseAlphabet);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:UpperCaseAlphabet:]", MyRPTP)), PredefinedCharClasses.UpperCaseAlphabet);
		...
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:AlphabetAndDigit:]",  MyRPTP)), PredefinedCharClasses.AlphabetAndDigit);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:Punctuation:]",       MyRPTP)), PredefinedCharClasses.Punctuation);
		...
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JNonDigit:]",      MyRPTP)), PredefinedCharClasses.Java_NonDigit);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JWhiteSpace:]",    MyRPTP)), PredefinedCharClasses.Java_WhiteSpace);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JNonWhiteSpace:]", MyRPTP)), PredefinedCharClasses.Java_NonWhiteSpace);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JWord:]",          MyRPTP)), PredefinedCharClasses.Java_Word);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JNonWord:]",       MyRPTP)), PredefinedCharClasses.Java_NonWord);
		
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JLowerCaseAlphabet:]", MyRPTP)), PredefinedCharClasses.Java_LowerCaseAlphabet);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JUpperCaseAlphabet:]", MyRPTP)), PredefinedCharClasses.Java_UpperCaseAlphabet);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JASCII:]",             MyRPTP)), PredefinedCharClasses.Java_ASCII);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JAlphabet:]",          MyRPTP)), PredefinedCharClasses.Java_Alphabet);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JAlphabetAndDigit:]",  MyRPTP)), PredefinedCharClasses.Java_AlphabetAndDigit);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JPunctuation:]",       MyRPTP)), PredefinedCharClasses.Java_Punctuation);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JVisible:]",           MyRPTP)), PredefinedCharClasses.Java_Visible);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JPrintable:]",         MyRPTP)), PredefinedCharClasses.Java_Printable);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JBlank:]",             MyRPTP)), PredefinedCharClasses.Java_Blank);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JControlCharacter:]",  MyRPTP)), PredefinedCharClasses.Java_ControlCharacter);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JHexadecimalDigit:]",  MyRPTP)), PredefinedCharClasses.Java_HexadecimalDigit);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JGreek:]",             MyRPTP)), PredefinedCharClasses.Java_Greek);
		Assert(RPCompiler_ParserTypes.getCharClass(RP.match("[:JCurrencySimbol:]",    MyRPTP)), PredefinedCharClasses.Java_CurrencySimbol);
		...
		if(PR == null) throw new AssertionError("PR should not be null.");
		...
		if(!IsQuiet) System.out.println(PR.toString());
		O = MyRPTP.getType(TName).compile(PR, null, null, MyRPTP).toString();
		if(!IsQuiet) System.out.println(Text);
		if(!IsQuiet) System.out.println(O);
		...
		if(!IsQuiet) System.out.println(RT);
